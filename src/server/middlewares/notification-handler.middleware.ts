...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'mentor.update': {
    roles: ['admin', 'business-owner'],
    key: 'mentor-profile-update',
    tenantPath: ['company', 'user', 'mentor'],
    userPath: [],
  },
  'appointment.create': {
    roles: ['mentor', 'admin', 'business-owner'],
    key: 'new-appointment',
    tenantPath: ['company', 'user', 'mentor', 'appointment'],
    userPath: [],
  },
  'appointment.update': {
    roles: ['mentor', 'admin', 'business-owner'],
...
const tenantRoles: string[] = ['mentor', 'admin', 'app-user'];
