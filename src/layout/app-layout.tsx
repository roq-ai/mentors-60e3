...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'mentor', 'admin', 'app-user'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'App Users', path: '/app-users', entity: 'app_user', service: AccessServiceEnum.PROJECT, icon: FiUserPlus },
    {
      name: 'Appointments',
      path: '/appointments',
      entity: 'appointment',
    ...
    { name: 'Mentors', path: '/mentors', entity: 'mentor', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
