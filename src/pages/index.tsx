  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Mentors - an innovative online platform connecting you to experienced guides. Schedule your appointments effortlessly and empower your journey to success."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1522881193457-37ae97c905bf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtZW50b3JzfGVufDB8fHx8MTY5MzYzMjYzNnww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Mentors - an innovative online platform connecting you to experienced guides. Schedule your appointments effortlessly and empower your journey to success.`}
            </Text>
            <Box
